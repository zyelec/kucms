...
<title><?php echo ($site_name); ?>- 产品展示</title>
...
<div class="rlist margintop">
	...
	<div class="ileft">
	  <div class="leftlist margintop">
			<div class="ptitle">
				<a href="news.php">产品展示</a>
			</div>

			<div class="pleft picnews">
					<dl>
					   <?php if(is_array($plist)): foreach($plist as $key=>$produce): ?><dd><a href='__URL__/show/id/<?php echo ($produce["id"]); ?>' target='_blank' class='pimg'><img src='__PUBLIC__/uploads/<?php echo ($produce["img"]); ?>' height="100" /></a><span><a href='__URL__/show/id/<?php echo ($produce["id"]); ?>' target='_blank'><?php echo ($produce["name"]); ?></a></span></dd><?php endforeach; endif; ?>
					</dl>
			</div>
