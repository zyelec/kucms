...
<table width="98%" align="center" border="0" cellpadding="3" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px;margin-top:8px;">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td width="82%"><select name="pid" id="parent_category">
	  <?php if(is_array($mlist)): $i = 0; $__LIST__ = $mlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cVo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($cVo["id"]); ?>" <?php if(($cVo["id"]) == $plist["pid"]): ?>selected<?php endif; ?>><?php echo ($cVo["catname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
	</select></td>
  </tr>
  <tr bgcolor="#FFFFFF">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td width="82%"><if condition="<?php echo ($plist["img"]); ?>"><img src="__PUBLIC__/uploads/<?php echo ($plist["img"]); ?>" height="150">
    <input type="hidden" name="img" value="<?php echo ($plist["img"]); ?>">    
