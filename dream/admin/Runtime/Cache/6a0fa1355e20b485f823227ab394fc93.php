<?php if (!defined('THINK_PATH')) exit();?><!-- 文章模型 -->
...
<tr bgcolor="#E7E7E7">
	<td height="30" colspan="8" background="__PUBLIC__/admin/images/tbg.gif"><span style="float:left; padding-top:3px; padding-left:5px;"><a href="__URL__/trash">文章列表</a></span>
...
<?php if(is_array($alist)): foreach($alist as $key=>$data): ?><tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td><a href="__URL__/edit/id/<?php echo ($data["id"]); ?>">编辑</a> | <a href="__URL__/doTrash/id/<?php echo ($data["id"]); ?>">删除到回收站</a></td>
