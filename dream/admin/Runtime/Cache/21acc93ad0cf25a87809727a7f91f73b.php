...
<tr bgcolor="#E7E7E7">
	<td height="30" colspan="8" background="__PUBLIC__/admin/images/tbg.gif"><span style="float:left; padding-top:3px; padding-left:5px;"><a href="__URL__">产品列表</a></span>
	<span style="float:left; padding-top:3px; padding-left:5px;"><a href="__URL__/trash">回收站</a></span></td>
</tr>
...
<?php if(is_array($plist)): foreach($plist as $key=>$data): ?><tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td align="left"><a href='__URL__/edit/id/<?php echo ($data["id"]); ?>'><u><?php echo ($data["name"]); ?></u></a></td>
