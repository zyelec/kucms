...
function delArc(aid){
	...
	{
	  if(confirm("是否将此产品删除?")){ 
	    location="/kucms/index.php/Admin/Page/del/id/"+id;
      }
	}else{
	    alert('请选择删除的产品');
	}
...
<tr bgcolor="#E7E7E7">
	...
	<input type='button' class="coolbg np" onClick="location='/kucms/index.php/Admin/Page/add/id/<?php echo ($alist["id"]); ?>';" value='<?php echo ($title); ?>' /></span></td>
</tr>
...
<?php if(is_array($alist)): foreach($alist as $key=>$data): ?><tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td align="left"><a href='/kucms/index.php/Admin/Page/edit/id/<?php echo ($data["id"]); ?>'><u><?php echo ($data["title"]); ?></u></a></td>
	<td><?php echo ($data["catname"]); ?></td>
	<td><a href="/kucms/index.php/Admin/Page/edit/id/<?php echo ($data["id"]); ?>">编辑</a> | <a href="/kucms/index.php/Admin/Page/del/id/<?php echo ($data["id"]); ?>">删除</a></td>
