...
<table width="98%" align="center" border="0" cellpadding="3" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px;margin-top:8px;">
  <tr>
    <td background="/kucms/Public/admin/images/frame/wbg.gif" bgcolor="#EEF4EA" class='title'><span>消息</span></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td>&nbsp;</td>
  </tr>
...
<table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
  <tr>
    <td colspan="2" background="/kucms/Public/admin/images/frame/wbg.gif" bgcolor="#EEF4EA" class='title'>
  ...
  <tr bgcolor="#FFFFFF">
    <td height="30" colspan="2" align="center" valign="bottom"><table width="100%" border="0" cellspacing="1" cellpadding="1">
        <tr>
          <td width="15%" height="31" align="center"><img src="/kucms/Public/admin/images/frame/qc.gif" width="90" height="30" /></td>
          <td width="85%" valign="bottom"><div class='icoitem'>
              <div class='ico'><img src='/kucms/Public/admin/images/frame/addnews.gif' width='16' height='16' /></div>
              <div class='txt'><a href=''><u>文档列表</u></a></div>
            </div>
            <div class='icoitem'>
              <div class='ico'><img src='/kucms/Public/admin/images/frame/menuarrow.gif' width='16' height='16' /></div>
              <div class='txt'><a href=''><u>评论管理</u></a></div>
            </div>
            <div class='icoitem'>
              <div class='ico'><img src='/kucms/Public/admin/images/frame/manage1.gif' width='16' height='16' /></div>
              <div class='txt'><a href=''><u>内容发布</u></a></div>
            </div>
            <div class='icoitem'>
              <div class='ico'><img src='/kucms/Public/admin/images/frame/file_dir.gif' width='16' height='16' /></div>
              <div class='txt'><a href=''><u>栏目管理</u></a></div>
            </div>
            <div class='icoitem'>
              <div class='ico'><img src='/kucms/Public/admin/images/frame/part-index.gif' width='16' height='16' /></div>
