...
<form id="add_news" name="add_news" method="post" action="/kucms/index.php/Admin/Page/doAdd" enctype="multipart/form-data" onSubmit="return confirmSubmit(this)">
<table width="98%" align="center" border="0" cellpadding="3" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px;margin-top:8px;">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td width="82%"><select name="cid" id="parent_category">
	  <?php if(is_array($clist)): $i = 0; $__LIST__ = $clist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cVo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($cVo["id"]); ?>"><?php $__FOR_START_30645__=1;$__FOR_END_30645__=$cVo["count"];for($i=$__FOR_START_30645__;$i < $__FOR_END_30645__;$i+=1){ ?>&nbsp;<?php } echo ($cVo["cname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
	</select></td>
  </tr>
  <tr bgcolor="#FFFFFF">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td width="82%">来源: <input type="text" size="5" name="from" value="本站原创"> 发布人: <input type="text" size="5" name="author" value="管理员"> 发布时间: <input type="text" name="addtime" size="8" value=<?php echo date("Y-m-d"); ?>></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td colspan="2">
