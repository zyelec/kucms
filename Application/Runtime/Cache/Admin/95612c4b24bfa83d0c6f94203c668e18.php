...
<table width="98%" align="center" border="0" cellpadding="3" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px;margin-top:8px;">
  ...
  <tr bgcolor="#FFFFFF">
	...
	<select name="parent_category" id="parent_category">
	  ...
	  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php $__FOR_START_18602__=0;$__FOR_END_18602__=$vo["count"];for($i=$__FOR_START_18602__;$i < $__FOR_END_18602__;$i+=1){ ?>&nbsp;&nbsp;<?php } echo ($vo["cname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
	</select>	
	</td>
  </tr>
  <tr bgcolor="#FFFFFF">
