...
<div class="box">
    ...
    <div class="nav">
        <ul>
            <li class="one"><a href="/kucms/index.php">é¦–é¡µ</a></li>
        ...
        <div class="plist">
            ...
            <div class="pright">
                    <dl>
                       ...
                       <dt><a href='/kucms/index.php/Home/Category/produce_view/id/<?php echo ($produce["id"]); ?>' target='_blank'>²úÆ·1</a></dt>
    ...
    <div class="footer">
        <div class="copyright">
            Copyright Â© 2014 - 2015  All Rights Reserved.<br>
             ç‰ˆæ¬Šæ‰€æœ‰
        </div>
    </div>
</body>
