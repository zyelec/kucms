    ...
    <div class="news">
        ...
        <div class="nlist">
            <div class="nlist_left">
                <ul>
                	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!-- http://localhost/kucms/index.php/Home/Category/index/id/113
                			/kucms/index.php/Home/Category/index/id/<?php echo ($clist["id"]); ?>
                		 -->
                		<li><a href="/kucms/index.php/Home/Category/show/module/<?php echo ($module); ?>/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
