...
<table width="98%" align="center" border="0" cellpadding="3" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px;margin-top:8px;">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td width="82%"><select name="cid" id="parent_category">
	  <?php if(is_array($clist)): $i = 0; $__LIST__ = $clist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cVo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($cVo["id"]); ?>" <?php if(($cVo["id"]) == $alist["cid"]): ?>selected<?php endif; ?>><?php $__FOR_START_9005__=1;$__FOR_END_9005__=$cVo['count'];for($i=$__FOR_START_9005__;$i < $__FOR_END_9005__;$i+=1){ ?>-<?php } echo ($cVo["cname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
	</select></td>
  </tr>
  <tr bgcolor="#FFFFFF">
